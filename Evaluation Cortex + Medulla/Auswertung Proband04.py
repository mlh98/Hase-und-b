...
path_save_45_l_bi = os.path.join(results_dir, 'Cortex + Medulla', 'links', '45_bi')
path_save_60_l_bi = os.path.join(results_dir, 'Cortex + Medulla', 'links', '60_bi')
path_save_75_l_bi = os.path.join(results_dir, 'Cortex + Medulla', 'links', '75_bi')
path_save_90_l_bi = os.path.join(results_dir, 'Cortex + Medulla', 'links', '90_bi')

path_save_45_r_bi = os.path.join(results_dir, 'Cortex + Medulla', 'rechts', '45_bi')
path_save_60_r_bi = os.path.join(results_dir, 'Cortex + Medulla', 'rechts', '60_bi')
path_save_75_r_bi = os.path.join(results_dir, 'Cortex + Medulla', 'rechts', '75_bi')
path_save_90_r_bi = os.path.join(results_dir, 'Cortex + Medulla', 'rechts', '90_bi')

# Paths for saving results (triexponential)
path_save_45_l_tri = os.path.join(results_dir, 'Cortex + Medulla', 'links', '45_tri')
path_save_60_l_tri = os.path.join(results_dir, 'Cortex + Medulla', 'links', '60_tri')
path_save_75_l_tri = os.path.join(results_dir, 'Cortex + Medulla', 'links', '75_tri')
path_save_90_l_tri = os.path.join(results_dir, 'Cortex + Medulla', 'links', '90_tri')

path_save_45_r_tri = os.path.join(results_dir, 'Cortex + Medulla', 'rechts', '45_tri')
path_save_60_r_tri = os.path.join(results_dir, 'Cortex + Medulla', 'rechts', '60_tri')
path_save_75_r_tri = os.path.join(results_dir, 'Cortex + Medulla', 'rechts', '75_tri')
path_save_90_r_tri = os.path.join(results_dir, 'Cortex + Medulla', 'rechts', '90_tri')
